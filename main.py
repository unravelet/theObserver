...
## adapt with code from: https://nrsyed.com/2018/07/05/multithreading-with-opencv-python-to-improve-video-processing-performance/
...
def threadBoth(source='../res/videos/video2.mp4'):
    """
